...
public class TradeLimitVO {
    ...
    public TradeLimitVO convert(FundData fundData) {
        ...
        listData.add(new BaseEntry(TradeLimitVOKey.MIN_PURCHASE_AMOUNT,
                ...
                "元"));
        listData.add(new BaseEntry(TradeLimitVOKey.FIRST_BUY_AMOUNT, fundData.getFirstBuyAmount() + "元"));
        listData.add(new BaseEntry(TradeLimitVOKey.SUPPLEMENT_AMOUNT, fundData.getSupplementAmount()+"元"));
        listData.add(new BaseEntry(TradeLimitVOKey.PURCHASE_LIMIT_ONE_DAY, fundData.getPurchaseLimitOneDay()+"元"));
        listData.add(new BaseEntry(TradeLimitVOKey.POSITIONS_LIMIT, fundData.getPositionsLimit()+"元"));
        listData.add(new BaseEntry(TradeLimitVOKey.MIN_REDEEM_SHARE, fundData.getMinRedeemShare()+"份"));
        listData.add(new BaseEntry(TradeLimitVOKey.MIN_REMAINING_SHARE, fundData.getMinRemainingShare()+"份"));
